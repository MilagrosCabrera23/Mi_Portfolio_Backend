...
proyectos = [
    Proyecto(
        ...
        imagen="https://milagroscabrera-portfoliobackend.onrender.com/assets/img/arg-broker.webp",
     ...
     Proyecto(
        id=2,
        categoria="Desarrollo Web",
        imagen="https://milagroscabrera-portfoliobackend.onrender.com/assets/img/ecommerce.webp",
    ...
    Proyecto(
        id=3,
        categoria="IOT",
        imagen="https://milagroscabrera-portfoliobackend.onrender.com/assets/img/prototipo-iot.webp",
        ...
        Proyecto(
            id=5, 
            imagen="https://milagroscabrera-portfoliobackend.onrender.com/assets/img/qr.webp",
            categoria="Desarrollo Web",
        ...
        Proyecto(
         ...
         Proyecto(
            id=7, 
            imagen="https://milagroscabrera-portfoliobackend.onrender.com/assets/img/acortador.webp",
            categoria="Desarrollo Web",
